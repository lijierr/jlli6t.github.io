var store = [{
        ...
        "title": "NCBI FTP下载",
        "excerpt":"NCBI的这个genome reports的FTP site下， ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/ 有真核： ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/eukaryotes.txt 原核： ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/prokaryotes.txt 病毒： ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/viruses.txt 质粒： ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/plasmids.txt 等数据库， 更新得挺频繁的。   如果想要下载基因组，可直接下载对应的文件，然后提供相应的关键字，即可批量下载。   1. 链接NCBI FTP基本操作     启动lftp, 这个是loading ftp的意思   cd ftp://ftp.ncbi.nih.gov。 这个是NCBI的ftp目录   cd genomes/refseq   mirror bacteria/   mirror archaea/   2. 测试  2.1 测试1 TargetedLoci目录  cd进入ftp://ftp.ncbi.nih.gov目录后 进入refseq目录， mget了README文件 接着mirror了TargetedLoci目录，这个目录里根据说明信息是Archae, Bacteria, Fungi的16s, 18s, 23s等数据。   2.2 测试2 Bacteria目录  接下来mirror了release/plasmid目录   mget RELEASE_NUMBER mirror archaea lftp ftp.ncbi.nih.gov:/refseq/release mirror bacteria  下载文件用mget命令，例如mget bacteria.16SrRNA.fna.gz 下载目录用mirror。   3 其他方法  ftp://ftp.ncbi.nlm.nih.gov/genomes/ASSEMBLY_REPORTS 这个目录下有相应的文件，包含每个序列的版本信息以及ftp地址等等，可以根据这里边的文件进行下载。   找到了一个更简洁的方法来下载genomes, https://www.ncbi.nlm.nih.gov/assembly 从这里边可以筛选你想要下载的东西，限制各种条件啊什么的。   https://ncbiinsights.ncbi.nlm.nih.gov/2018/11/16/refseq-release-91/ RefSeq91发布了，ftp地址： https://ftp.ncbi.nlm.nih.gov/refseq/release/  ","categories": ["database","genome"],
        "tags": ["genome","NCBI"],
        "url": "/database/genome/NCBI_FTP_download/",
        "teaser": null
      },{
    ...
    "title": null,
    "excerpt":"\r \r \r   404 \r \r   Page not found :( \r   The requested page could not be found. \r \r ","url": "http://localhost:4000/404.html"
  },{
    "title": "",
    "excerpt":"Jie did her PhD with Professor Jianhua Guo and Professor Gene Tyson with focus on microbial ecology and bioinformatics.   With passion on microbial ecology, Jie has contributed to publications. The passion extends to coding as well. Jie has led the development of pipelines.   Jie has worked in a wide range of different environments from molecular biology science to bioinformatics. The wet lab experience of molecular biology aids in data analysis a lots. It’s exciting to work with different people and to learn from different professionals. These experiences largely diversified her skillset and enabled a solid foundation for her as an independent researcher.     ","url": "http://localhost:4000/about/"
  },{
    "title": null,
    "excerpt":"","url": "http://localhost:4000/"
  },{
    "title": null,
    "excerpt":"var idx = lunr(function () {\r   this.field('title')\r   this.field('excerpt')\r   this.field('categories')\r   this.field('tags')\r   this.ref('id')\r \r   this.pipeline.remove(lunr.trimmer)\r \r   for (var item in store) {\r     this.add({\r       title: store[item].title,\r       excerpt: store[item].excerpt,\r       categories: store[item].categories,\r       tags: store[item].tags,\r       id: item\r     })\r   }\r });\r \r $(document).ready(function() {\r   $('input#search').on('keyup', function () {\r     var resultdiv = $('#results');\r     var query = $(this).val().toLowerCase();\r     var result =\r       idx.query(function (q) {\r         query.split(lunr.tokenizer.separator).forEach(function (term) {\r           q.term(term, { boost: 100 })\r           if(query.lastIndexOf(\" \") != query.length-1){\r             q.term(term, {  usePipeline: false, wildcard: lunr.Query.wildcard.TRAILING, boost: 10 })\r           }\r           if (term != \"\"){\r             q.term(term, {  usePipeline: false, editDistance: 1, boost: 1 })\r           }\r         })\r       });\r     resultdiv.empty();\r     resultdiv.prepend(''+result.length+' Result(s) found ');\r     for (var item in result) {\r       var ref = result[item].ref;\r       if(store[ref].teaser){\r         var searchitem =\r           ''+\r             ''+\r               ''+\r                 ''+store[ref].title+''+\r               ' '+\r               ''+\r                 ''+\r               ''+\r               ''+store[ref].excerpt.split(\" \").splice(0,20).join(\" \")+'... '+\r             ''+\r           '';\r       }\r       else{\r     \t  var searchitem =\r           ''+\r             ''+\r               ''+\r                 ''+store[ref].title+''+\r               ' '+\r               ''+store[ref].excerpt.split(\" \").splice(0,20).join(\" \")+'... '+\r             ''+\r           '';\r       }\r       resultdiv.append(searchitem);\r     }\r   });\r });\r ","url": "http://localhost:4000/assets/js/lunr/lunr-en.js"
  },{
    "title": null,
    "excerpt":"step1list = new Array();\r step1list[\"ΦΑΓΙΑ\"] = \"ΦΑ\";\r step1list[\"ΦΑΓΙΟΥ\"] = \"ΦΑ\";\r step1list[\"ΦΑΓΙΩΝ\"] = \"ΦΑ\";\r step1list[\"ΣΚΑΓΙΑ\"] = \"ΣΚΑ\";\r step1list[\"ΣΚΑΓΙΟΥ\"] = \"ΣΚΑ\";\r step1list[\"ΣΚΑΓΙΩΝ\"] = \"ΣΚΑ\";\r step1list[\"ΟΛΟΓΙΟΥ\"] = \"ΟΛΟ\";\r step1list[\"ΟΛΟΓΙΑ\"] = \"ΟΛΟ\";\r step1list[\"ΟΛΟΓΙΩΝ\"] = \"ΟΛΟ\";\r step1list[\"ΣΟΓΙΟΥ\"] = \"ΣΟ\";\r step1list[\"ΣΟΓΙΑ\"] = \"ΣΟ\";\r step1list[\"ΣΟΓΙΩΝ\"] = \"ΣΟ\";\r step1list[\"ΤΑΤΟΓΙΑ\"] = \"ΤΑΤΟ\";\r step1list[\"ΤΑΤΟΓΙΟΥ\"] = \"ΤΑΤΟ\";\r step1list[\"ΤΑΤΟΓΙΩΝ\"] = \"ΤΑΤΟ\";\r step1list[\"ΚΡΕΑΣ\"] = \"ΚΡΕ\";\r step1list[\"ΚΡΕΑΤΟΣ\"] = \"ΚΡΕ\";\r step1list[\"ΚΡΕΑΤΑ\"] = \"ΚΡΕ\";\r step1list[\"ΚΡΕΑΤΩΝ\"] = \"ΚΡΕ\";\r step1list[\"ΠΕΡΑΣ\"] = \"ΠΕΡ\";\r step1list[\"ΠΕΡΑΤΟΣ\"] = \"ΠΕΡ\";\r step1list[\"ΠΕΡΑΤΑ\"] = \"ΠΕΡ\";\r step1list[\"ΠΕΡΑΤΩΝ\"] = \"ΠΕΡ\";\r step1list[\"ΤΕΡΑΣ\"] = \"ΤΕΡ\";\r step1list[\"ΤΕΡΑΤΟΣ\"] = \"ΤΕΡ\";\r step1list[\"ΤΕΡΑΤΑ\"] = \"ΤΕΡ\";\r step1list[\"ΤΕΡΑΤΩΝ\"] = \"ΤΕΡ\";\r step1list[\"ΦΩΣ\"] = \"ΦΩ\";\r step1list[\"ΦΩΤΟΣ\"] = \"ΦΩ\";\r step1list[\"ΦΩΤΑ\"] = \"ΦΩ\";\r step1list[\"ΦΩΤΩΝ\"] = \"ΦΩ\";\r step1list[\"ΚΑΘΕΣΤΩΣ\"] = \"ΚΑΘΕΣΤ\";\r step1list[\"ΚΑΘΕΣΤΩΤΟΣ\"] = \"ΚΑΘΕΣΤ\";\r step1list[\"ΚΑΘΕΣΤΩΤΑ\"] = \"ΚΑΘΕΣΤ\";\r step1list[\"ΚΑΘΕΣΤΩΤΩΝ\"] = \"ΚΑΘΕΣΤ\";\r step1list[\"ΓΕΓΟΝΟΣ\"] = \"ΓΕΓΟΝ\";\r step1list[\"ΓΕΓΟΝΟΤΟΣ\"] = \"ΓΕΓΟΝ\";\r step1list[\"ΓΕΓΟΝΟΤΑ\"] = \"ΓΕΓΟΝ\";\r step1list[\"ΓΕΓΟΝΟΤΩΝ\"] = \"ΓΕΓΟΝ\";\r \r v = \"[ΑΕΗΙΟΥΩ]\";\r v2 = \"[ΑΕΗΙΟΩ]\"\r \r function stemWord(w) {\r   var stem;\r   var suffix;\r   var firstch;\r   var origword = w;\r   test1 = new Boolean(true);\r \r   if(w.length '+result.length+' Result(s) found ');\r     for (var item in result) {\r       var ref = result[item].ref;\r       if(store[ref].teaser){\r         var searchitem =\r           ''+\r             ''+\r               ''+\r                 ''+store[ref].title+''+\r               ' '+\r               ''+\r                 ''+\r               ''+\r               ''+store[ref].excerpt.split(\" \").splice(0,20).join(\" \")+'... '+\r             ''+\r           '';\r       }\r       else{\r     \t  var searchitem =\r           ''+\r             ''+\r               ''+\r                 ''+store[ref].title+''+\r               ' '+\r               ''+store[ref].excerpt.split(\" \").splice(0,20).join(\" \")+'... '+\r             ''+\r           '';\r       }\r       resultdiv.append(searchitem);\r     }\r   });\r });\r ","url": "http://localhost:4000/assets/js/lunr/lunr-gr.js"
  },{
    "title": null,
    "excerpt":"var store = [\r   {%- for c in site.collections -%}\r     {%- if forloop.last -%}\r       {%- assign l = true -%}\r     {%- endif -%}\r     {%- assign docs = c.docs | where_exp:'doc','doc.search != false' -%}\r     {%- for doc in docs -%}\r       {%- if doc.header.teaser -%}\r         {%- capture teaser -%}{{ doc.header.teaser }}{%- endcapture -%}\r       {%- else -%}\r         {%- assign teaser = site.teaser -%}\r       {%- endif -%}\r       {\r         \"title\": {{ doc.title | jsonify }},\r         \"excerpt\":\r           {%- if site.search_full_content == true -%}\r             {{ doc.content | newline_to_br |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \"|\r             strip_html | strip_newlines | jsonify }},\r           {%- else -%}\r             {{ doc.content | newline_to_br |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \" |\r               replace:\" \", \" \"|\r             strip_html | strip_newlines | truncatewords: 50 | jsonify }},\r           {%- endif -%}\r         \"categories\": {{ doc.categories | jsonify }},\r         \"tags\": {{ doc.tags | jsonify }},\r         \"url\": {{ doc.url | relative_url | jsonify }},\r         \"teaser\": {{ teaser | relative_url | jsonify }}\r       }{%- unless forloop.last and l -%},{%- endunless -%}\r     {%- endfor -%}\r   {%- endfor -%}{%- if site.lunr.search_within_pages -%},\r   {%- assign pages = site.pages | where_exp:'doc','doc.search != false' -%}\r   {%- for doc in pages -%}\r     {%- if forloop.last -%}\r       {%- assign l = true -%}\r     {%- endif -%}\r   {\r     \"title\": {{ doc.title | jsonify }},\r     \"excerpt\":\r         {%- if site.search_full_content == true -%}\r           {{ doc.content | newline_to_br |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \"|\r           strip_html | strip_newlines | jsonify }},\r         {%- else -%}\r           {{ doc.content | newline_to_br |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \" |\r             replace:\" \", \" \"|\r           strip_html | strip_newlines | truncatewords: 50 | jsonify }},\r         {%- endif -%}\r       \"url\": {{ doc.url | absolute_url | jsonify }}\r   }{%- unless forloop.last and l -%},{%- endunless -%}\r   {%- endfor -%}\r {%- endif -%}]\r ","url": "http://localhost:4000/assets/js/lunr/lunr-store.js"
  },{
    "title": "",
    "excerpt":"### 文献解读-anammox - [DNRA微生物的繁殖降低anammox表现](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487496&idx=1&sn=ab1ca9db976480a8aed1f7b14a8c5e22&chksm=fd43c9eaca3440fcc57a4ea7b887d4ad28dcd0b15aaba8787c2be73de9b026d3e6f55e049314&token=1051470455&lang=zh_CN#rd) - [ISME:昆士兰大学Gene Tyson组耦合AOM和Mn(IV)还原新古菌的富集和鉴定](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487458&idx=1&sn=abcad5a7314023c597058f6ff5620043&chksm=fd43d600ca345f16df0a9efc46b5e1efcbc5206b6e514eb43157b9d324698725d245989034d6&token=1051470455&lang=zh_CN#rd) - [ISME:昆士兰大学袁志国组耦合AOM和Fe(III)还原古菌的富集和鉴定](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487301&idx=1&sn=d426c1ca0a136060bfee2b8eb63e68ce&chksm=fd43d6a7ca345fb12ae9fe25732ef707006e62732575931fe4a8bb50df448d76c059a67739da&token=1051470455&lang=zh_CN#rd) - [WR: 日本北海道大学Satoshi Okabe组解析nitrite限制的反应器中anammox细菌之间的竞争](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486441&idx=1&sn=d59ea3691c9da7e819f9a78b0f84a950&chksm=fd43d20bca345b1d704a7d2d9546ec9ff55fe3caa4b112bb2b1e643ae6e6b74543edd5c78a89&token=1051470455&lang=zh_CN#rd) - [NC: 威斯康星大学Daniel Noguera组代谢网络分析揭示anammox颗粒中微生物群落间互作](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486293&idx=1&sn=df32d6a3448947b872f997d85ee4d059&chksm=fd43d2b7ca345ba10c79a5936d334973dc947648f3a68cac3716c68932284db845c9a86fb2e9&token=1051470455&lang=zh_CN#rd) - [NC: 荷兰内梅亨大学Mike Jetten组宏基因组技术解析anammox颗粒型full-scale污水处理系统中的微生态](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486293&idx=2&sn=5f7a1332bc2e997389a2c4827cb644b1&chksm=fd43d2b7ca345ba15ac8e9c2a80127313b0ba80205c282977585e1f0d5929193e57b80cde113&token=1051470455&lang=zh_CN#rd) - [EM：清华王洪涛组看anammox和DAMO如何随季节动态共存](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486202&idx=1&sn=e77a045d89f9b81bd31c990566e20454&chksm=fd43d318ca345a0eb5eed0708413cdc355524b884661948f2979524f2cff3ddff6082c638248&token=1051470455&lang=zh_CN#rd) - [NC: 代谢网络分析揭示anammox颗粒中微生物群落间互作](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247485392&idx=1&sn=0af9b786222f39b3db2dda3e4e19f6c6&chksm=fd43de32ca345724662ea2192cf7bec4927c4a821036fb5d13ce8efd6e6f211cb9200d850377&token=1051470455&lang=zh_CN#rd) - [AMB：北大刘思彤组多组学揭示Anammox细菌之间的竞争关系](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486017&idx=1&sn=25f0495797ea1e651f31061704770a40&chksm=fd43d3a3ca345ab52a7025050d0a9eb012b2d247aae5907d66563143e397765311a7e37176b4&token=1051470455&lang=zh_CN#rd)  ### 工具介绍 - [SortMeRNA，Burst trie+查找表，Levenshtein自动机搜索快速精准鉴定rRNA](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487476&idx=1&sn=03958545293b8b7c2b650a53212945f1&chksm=fd43d616ca345f00f9327b1d4cfe149a847c1b823be249e33bd27031a94fbad10e2c200429d5&token=1051470455&lang=zh_CN#rd) - [项目开源时如何选择License？](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487067&idx=1&sn=d5481dd3feb46b36fd5d2b2ae7c16812&chksm=fd43d7b9ca345eafd6b5ac20e7d9cefe6f1f1d177518ede35047d15d593e4c42c5912e12f131&token=1051470455&lang=zh_CN#rd) - [git学习（二）之远端仓库操作](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247486732&idx=1&sn=955a6959c113a073559fad5e7c1acab7&chksm=fd43d4eeca345df86d0f4052ae093e28550ae2c3b3a0ee95a5cacc82d49c443ea2a01acfa8da&token=1051470455&lang=zh_CN#rd) - [git学习（一）之本地仓库操作](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487067&idx=2&sn=f7fc1104c2dd01d2f917a0d3f6749e80&chksm=fd43d7b9ca345eaff24053729b242c8b8a4f4bef69d4bed52024767e94c34b1b1155a98c3358&token=1051470455&lang=zh_CN#rd) - [SRA数据处理工具-sratoolkit](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247485891&idx=3&sn=7c6282524aec80edb4777f4d33b9ed84&chksm=fd43d021ca3459371828bb10b083c5e18abf9bca011b4c483c4d4ed87fee9aac13c5bb104cb2&token=1051470455&lang=zh_CN#rd) - [macOS终端工具-iterm2](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247485392&idx=2&sn=5bfac48c5838f522d51bf1e54b44c20b&chksm=fd43de32ca345724921baaef6988d638ed0210fc3a336bb21065d970c10195571b4a27c172b6&token=1051470455&lang=zh_CN#rd)  ### Python - [序列迭代'Readfq' 和'FastqGeneralIterator'谁更快](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487325&idx=1&sn=2045680a0572548bd5ba6c097d8ed318&chksm=fd43d6bfca345fa998ec0c5fbaa2f234f4820d82086bad38aed1dc7b69c8d0ead30b87abd2fb&token=1051470455&lang=zh_CN#rd) - [基于setuptools打包python项目的demo](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487313&idx=1&sn=b0ab9227c36e2d6b1d4e686dd168b8fa&chksm=fd43d6b3ca345fa5cd3512ed163c005db86fe90e48ea86a9c4fcf35cca72a48b617ef977e365&token=1051470455&lang=zh_CN#rd) - [编译Python3时配置TCL-TK](https://mp.weixin.qq.com/s?__biz=MzU4MTc2NzMwOQ==&mid=2247487087&idx=1&sn=99c272089d6d4bc5d90fd58b08fe6d74&chksm=fd43d78dca345e9be915c0b5a93e1b859eb060566df582b0888056dec700e6ad2c73652ebec7&token=1051470455&lang=zh_CN#rd) ","url": "http://localhost:4000/media/"
  },{
    "title": "",
    "excerpt":"## [ReadTrim](ttps://github.com/jlli6t/ReadTrim)\r ![]({{ 'assets/picbed/cover/cover5.jpg' | relative_url}})\r **[ReadTrim](https://github.com/jlli6t/ReadTrim)** is a workflow for Short read QC, includes modules for adapter, duplicates, poor quality ends trimming.\r \r ## [BioSut](https://github.com/jlli6t/biosut)\r ![]({{ 'assets/picbed/cover/cover2.jpg' | relative_url}})\r **[BioSut](https://github.com/jlli6t/biosut)** is a Python package that integrated few useful utils.\r \r ## [gccov](https://github.com/jlli6t/gccov)\r ![]({{ 'assets/picbed/cover/cover4.jpg' | relative_url}})\r **[gccov](https://github.com/jlli6t/gccov)**, a light tool used for visualization of GC and coverage of assemblies.\r \r This light tool is useful when you want to look at the GC and coverage distribution of the contigs or scaffolds.\r ","url": "http://localhost:4000/projects/"
  },{
    "title": "",
    "excerpt":"## Book chapter\r [1]. Jianhua Guo, Yue Wang, Yunus Ahmed, Min Jin, **Jie Li**. [Control strategies to combat dissemination of antibiotic resistance in urban water systems. Antibiotic Resistance in the Environment: A Worldwide Overview](https://link.springer.com/chapter/10.1007/698_2020_474). The Handbook of Environmental Chemistry, Springer, 2020: 147-187.\r \r ## Publications\r [11]. Mengxiong Wu#, **Jie Li#**, Andy O Leu, Dirk V Erler, Terra Stark, Gene W. Tyson, Zhiguo Yuan, Simon J. McIlroy*, Jianhua Guo\\* [Anaerobic oxidation of propane coupled to nitrate reduction by a novel lineage of the class Symbiobacteriia](https://www.nature.com/articles/s41467-022-33872-y). Nature Communications, 2022, 13(1): 6115. **(co-first author)**\r \r [10]. Jing Zhao, Min Zheng*, Zicheng Su, Tao Liu, **Jie Li**, Jianhua Guo, Zhiguo Yuan, Shihu Hu. [Selective Enrichment of Comammox Nitrospira in a Moving Bed Biofilm Reactor with Sufficient Oxygen Supply](https://pubs.acs.org/doi/abs/10.1021/acs.est.2c03299). Environmental Science & Technology, 2022, 56(18): 13338-13346.\r \r [9]. Jing Zhao, Gaofeng Ni, Maria Piculell, **Jie Li**, Zhetai Hu, Zhiyao Wang, Jianhua Guo, Zhiguo Yuan, Min Zheng*, Shihu Hu\\*. [Characterizing and comparing microbial community and biofilm structure in three nitrifying moving bed biofilm reactors](https://doi.org/10.1016/j.jenvman.2022.115883). Journal of Environmental Management, 2022, 320: 115883.\r \r [8]. Yue Wang, Ji Lu, Shuai Zhang, **Jie Li**, Likai Mao, Zhiguo Yuan, Philip L. Bond, Jianhua Guo\\*. [Non-antibiotic pharmaceuticals promote the transmission of multidrug resistance plasmids through intra-and intergenera conjugation](https://www.nature.com/articles/s41396-021-00945-7). The ISME Journal, 2021, 15(9): 2493-2508.\r \r [7]. Jiyun Li#, Zheng-Shuang Hua#, Tao Liu, Chengwen Wang\\*, **Jie Li**, Ge Bai, Sebastian Lucker, Mike SM Jetten, Min Zheng*, Jianhua Guo\\*. [Selective enrichment and metagenomic analysis of three novel comammox Nitrospira in a urine-fed membrane bioreactor](https://www.nature.com/articles/s43705-021-00005-3). ISME Communications, 2021, 1(1): 7.\r \r [6]. Hui Chen, Tao Liu, **Jie Li**, Likai Mao, Jun Ye, Xiaoyu Han, Mike SM Jetten, Jianhua Guo\\*. [Larger anammox granules not only harbor higher species diversity but also support more functional diversity](https://pubs.acs.org/doi/full/10.1021/acs.est.0c02609). Environmental Science & Technology, 2020, 54(22): 14664-14673.\r \r [5]. Tao Liu, **Jie Li**, Zhuan Khai Lim, Hui Chen, Shihu Hu, Zhiguo Yuan, Jianhua Guo\\*. [Simultaneous removal of dissolved methane and nitrogen from synthetic mainstream anaerobic effluent](https://pubs.acs.org/doi/full/10.1021/acs.est.0c00912). Environmental Science & Technology, 2020, 54(12): 7629-7638.\r \r [4]. Yue Wang, Ji Lu, Likai Mao, **Jie Li**, Zhiguo Yuan, Philip L. Bond, Jianhua Guo\\*. [Antiepileptic drug carbamazepine promotes horizontal transfer of plasmid-borne multi-antibiotic resistance genes within and across bacterial genera](https://www.nature.com/articles/s41396-018-0275-x). The ISME Journal, 2019, 13(2): 509-522.\r \r [3]. Ji Lu, Yue Wang, **Jie Li**, Likai Mao, Son Hoang Nguyen, Tania Duarte, Lachlan Coin, Philip L. Bond, Zhiguo Yuan, Jianhua Guo\\*. [Triclosan at environmentally relevant concentrations promotes horizontal transfer of multidrug resistance genes within and across bacterial genera](https://www.sciencedirect.com/science/article/pii/S0160412018317264). Environment international, 2018, 121: 1217-1226.\r \r [2] Ji Lu, Min Jin, Son Hoang Nguyen, Likai Mao, **Jie Li**, Lachlan JM Coin, Zhiguo Yuan, Jianhua Guo\\*. [Non-antibiotic antimicrobial triclosan induces multiple antibiotic resistance through genetic mutation](https://www.sciencedirect.com/science/article/pii/S0160412018303672). Environment international, 2018, 118: 257-265.\r \r [1] Jianhua Guo*, **Jie Li**, Hui Chen, Philip L. Bond, Zhiguo Yuan. [Metagenomic analysis reveals wastewater treatment plants as hotspots of antibiotic resistance genes and mobile genetic elements](https://www.sciencedirect.com/science/article/pii/S0043135417305651). Water research, 2017, 123: 468-478.\r \r ## Categorize publications into research field\r ### Microbial ecology related publications\r [6]. Mengxiong Wu#, **Jie Li#**, Andy O Leu, Dirk V Erler, Terra Stark, Gene W. Tyson, Zhiguo Yuan, Simon J. McIlroy*, Jianhua Guo\\* [Anaerobic oxidation of propane coupled to nitrate reduction by a novel lineage of the class Symbiobacteriia](https://www.nature.com/articles/s41467-022-33872-y). Nature Communications, 2022, 13(1): 6115. **(co-first author)**\r \r [5]. Jing Zhao, Min Zheng*, Zicheng Su, Tao Liu, **Jie Li**, Jianhua Guo, Zhiguo Yuan, Shihu Hu. [Selective Enrichment of Comammox Nitrospira in a Moving Bed Biofilm Reactor with Sufficient Oxygen Supply](https://pubs.acs.org/doi/abs/10.1021/acs.est.2c03299). Environmental Science & Technology, 2022, 56(18): 13338-13346.\r \r [4]. Jing Zhao, Gaofeng Ni, Maria Piculell, **Jie Li**, Zhetai Hu, Zhiyao Wang, Jianhua Guo, Zhiguo Yuan, Min Zheng*, Shihu Hu\\*. [Characterizing and comparing microbial community and biofilm structure in three nitrifying moving bed biofilm reactors](https://doi.org/10.1016/j.jenvman.2022.115883). Journal of Environmental Management, 2022, 320: 115883.\r \r [3]. Jiyun Li#, Zheng-Shuang Hua#, Tao Liu, Chengwen Wang\\*, **Jie Li**, Ge Bai, Sebastian Lucker, Mike SM Jetten, Min Zheng*, Jianhua Guo\\*. [Selective enrichment and metagenomic analysis of three novel comammox Nitrospira in a urine-fed membrane bioreactor](https://www.nature.com/articles/s43705-021-00005-3). ISME Communications, 2021, 1(1): 7.\r \r [2]. Hui Chen, Tao Liu, **Jie Li**, Likai Mao, Jun Ye, Xiaoyu Han, Mike SM Jetten, Jianhua Guo\\*. [Larger anammox granules not only harbor higher species diversity but also support more functional diversity](https://pubs.acs.org/doi/full/10.1021/acs.est.0c02609). Environmental Science & Technology, 2020, 54(22): 14664-14673.\r \r [1]. Tao Liu, **Jie Li**, Zhuan Khai Lim, Hui Chen, Shihu Hu, Zhiguo Yuan, Jianhua Guo\\*. [Simultaneous removal of dissolved methane and nitrogen from synthetic mainstream anaerobic effluent](https://pubs.acs.org/doi/full/10.1021/acs.est.0c00912). Environmental Science & Technology, 2020, 54(12): 7629-7638.\r \r ### ARG related publications\r [5]. Yue Wang, Ji Lu, Shuai Zhang, **Jie Li**, Likai Mao, Zhiguo Yuan, Philip L. Bond, Jianhua Guo\\*. [Non-antibiotic pharmaceuticals promote the transmission of multidrug resistance plasmids through intra-and intergenera conjugation](https://www.nature.com/articles/s41396-021-00945-7). The ISME Journal, 2021, 15(9): 2493-2508.\r \r [4]. Yue Wang, Ji Lu, Likai Mao, **Jie Li**, Zhiguo Yuan, Philip L. Bond, Jianhua Guo\\*. [Antiepileptic drug carbamazepine promotes horizontal transfer of plasmid-borne multi-antibiotic resistance genes within and across bacterial genera](https://www.nature.com/articles/s41396-018-0275-x). The ISME Journal, 2019, 13(2): 509-522.\r \r [3]. Ji Lu, Yue Wang, **Jie Li**, Likai Mao, Son Hoang Nguyen, Tania Duarte, Lachlan Coin, Philip L. Bond, Zhiguo Yuan, Jianhua Guo\\*. [Triclosan at environmentally relevant concentrations promotes horizontal transfer of multidrug resistance genes within and across bacterial genera](https://www.sciencedirect.com/science/article/pii/S0160412018317264). Environment international, 2018, 121: 1217-1226.\r \r [2] Ji Lu, Min Jin, Son Hoang Nguyen, Likai Mao, **Jie Li**, Lachlan JM Coin, Zhiguo Yuan, Jianhua Guo\\*. [Non-antibiotic antimicrobial triclosan induces multiple antibiotic resistance through genetic mutation](https://www.sciencedirect.com/science/article/pii/S0160412018303672). Environment international, 2018, 118: 257-265.\r \r [1] Jianhua Guo*, **Jie Li**, Hui Chen, Philip L. Bond, Zhiguo Yuan. [Metagenomic analysis reveals wastewater treatment plants as hotspots of antibiotic resistance genes and mobile genetic elements](https://www.sciencedirect.com/science/article/pii/S0043135417305651). Water research, 2017, 123: 468-478.","url": "http://localhost:4000/publications/"
  },{
    "title": "bash",
    "excerpt":"","url": "http://localhost:4000/tags/bash/"
  },{
    "title": "linux",
    "excerpt":"","url": "http://localhost:4000/tags/linux/"
  },{
    "title": "protein",
    "excerpt":"","url": "http://localhost:4000/tags/protein/"
  },{
    "title": "annotation",
    "excerpt":"","url": "http://localhost:4000/tags/annotation/"
  },{
    "title": "gene",
    "excerpt":"","url": "http://localhost:4000/tags/gene/"
  },{
    "title": "genome",
    "excerpt":"","url": "http://localhost:4000/tags/genome/"
  },{
    "title": "NCBI",
    "excerpt":"","url": "http://localhost:4000/tags/ncbi/"
  },{
    "title": "prokaryotic",
    "excerpt":"","url": "http://localhost:4000/tags/prokaryotic/"
  },{
    "title": "amplicon",
    "excerpt":"","url": "http://localhost:4000/tags/amplicon/"
  },{
    "title": "pathway",
    "excerpt":"","url": "http://localhost:4000/tags/pathway/"
  },{
    "title": "sequencing data",
    "excerpt":"","url": "http://localhost:4000/tags/sequencing-data/"
  },{
    "title": "quality control",
    "excerpt":"","url": "http://localhost:4000/tags/quality-control/"
  },{
    "title": "TCK-TK",
    "excerpt":"","url": "http://localhost:4000/tags/tck-tk/"
  },{
    "title": "environment",
    "excerpt":"","url": "http://localhost:4000/tags/environment/"
  },{
    "title": "fastq",
    "excerpt":"","url": "http://localhost:4000/tags/fastq/"
  },{
    "title": "fasta",
    "excerpt":"","url": "http://localhost:4000/tags/fasta/"
  },{
    "title": "sequence",
    "excerpt":"","url": "http://localhost:4000/tags/sequence/"
  },{
    "title": "syntax",
    "excerpt":"","url": "http://localhost:4000/tags/syntax/"
  },{
    "title": "tutorials",
    "excerpt":"","url": "http://localhost:4000/tags/tutorials/"
  },{
    "title": "RNA",
    "excerpt":"","url": "http://localhost:4000/tags/rna/"
  },{
    "title": "mapping",
    "excerpt":"","url": "http://localhost:4000/tags/mapping/"
  },{
    "title": "protein sequence alignment",
    "excerpt":"","url": "http://localhost:4000/tags/protein-sequence-alignment/"
  },{
    "title": "alignment",
    "excerpt":"","url": "http://localhost:4000/tags/alignment/"
  },{
    "title": "perl",
    "excerpt":"","url": "http://localhost:4000/tags/perl/"
  },{
    "title": "probability",
    "excerpt":"","url": "http://localhost:4000/tags/probability/"
  },{
    "title": "taxonomy",
    "excerpt":"","url": "http://localhost:4000/tags/taxonomy/"
  },{
    "title": "tutorial",
    "excerpt":"","url": "http://localhost:4000/tags/tutorial/"
  },{
    "title": "git",
    "excerpt":"","url": "http://localhost:4000/tags/git/"
  },{
    "title": "rRNA",
    "excerpt":"","url": "http://localhost:4000/tags/rrna/"
  },{
    "title": "estimation",
    "excerpt":"","url": "http://localhost:4000/tags/estimation/"
  },{
    "title": "database",
    "excerpt":"","url": "http://localhost:4000/tags/database/"
  },{
    "title": "rawdate",
    "excerpt":"","url": "http://localhost:4000/tags/rawdate/"
  },{
    "title": "SRA",
    "excerpt":"","url": "http://localhost:4000/tags/sra/"
  },{
    "title": "python",
    "excerpt":"","url": "http://localhost:4000/tags/python/"
  },{
    "title": "coding",
    "excerpt":"","url": "http://localhost:4000/categories/coding/"
  },{
    "title": "bash",
    "excerpt":"","url": "http://localhost:4000/categories/bash/"
  },{
    "title": "database",
    "excerpt":"","url": "http://localhost:4000/categories/database/"
  },{
    "title": "protein",
    "excerpt":"","url": "http://localhost:4000/categories/protein/"
  },{
    "title": "genome",
    "excerpt":"","url": "http://localhost:4000/categories/genome/"
  },{
    "title": "bioinformatics",
    "excerpt":"","url": "http://localhost:4000/categories/bioinformatics/"
  },{
    "title": "amplicon",
    "excerpt":"","url": "http://localhost:4000/categories/amplicon/"
  },{
    "title": "quality control",
    "excerpt":"","url": "http://localhost:4000/categories/quality-control/"
  },{
    "title": "python",
    "excerpt":"","url": "http://localhost:4000/categories/python/"
  },{
    "title": "metatranscriptomic",
    "excerpt":"","url": "http://localhost:4000/categories/metatranscriptomic/"
  },{
    "title": "annotation",
    "excerpt":"","url": "http://localhost:4000/categories/annotation/"
  },{
    "title": "alignment",
    "excerpt":"","url": "http://localhost:4000/categories/alignment/"
  },{
    "title": "perl",
    "excerpt":"","url": "http://localhost:4000/categories/perl/"
  },{
    "title": "statistics",
    "excerpt":"","url": "http://localhost:4000/categories/statistics/"
  },{
    "title": "probability",
    "excerpt":"","url": "http://localhost:4000/categories/probability/"
  },{
    "title": "linux",
    ...
    "title": "rRNA",
    "excerpt":"","url": "http://localhost:4000/categories/rrna/"
  },{
    "title": "estimation",
    "excerpt":"","url": "http://localhost:4000/categories/estimation/"
  },{
    "title": "SRA",
    "excerpt":"","url": "http://localhost:4000/categories/sra/"
  },{
    "title": "gene",
    "excerpt":"","url": "http://localhost:4000/categories/gene/"
  },{
    "title": null,
